...
The Machine Learning Monthly Newsletter is a community-run newsletter emailed every first Tuesday of the month. The complete [archives are here](https://www.adafruitdaily.com/category/circuitpython/). To contribute, edit next month's draft [on GitHub](https://github.com/adafruit/machinelearning-newsletter/tree/master/_drafts) and [submit a pull request](https://help.github.com/articles/editing-files-in-your-repository/) with the changes. Join our [Discord](https://adafru.it/discord) or [post to the forum](https://forums.adafruit.com/viewforum.php?f=60) for any further questions.
